 ...
 */
#ifndef LOCATION_SERVICE_COM_LOMIRI_LOCATION_CONNECTIVITY_BOUNDED_INTEGER_H_
#define LOCATION_SERVICE_COM_LOMIRI_LOCATION_CONNECTIVITY_BOUNDED_INTEGER_H_
