...
#ifndef LOCATION_SERVICE_COM_LOMIRI_LOCATION_SERVICE_PROVIDERS_REMOTE_INTERFACE_H_
#define LOCATION_SERVICE_COM_LOMIRI_LOCATION_SERVICE_PROVIDERS_REMOTE_INTERFACE_H_
...
struct Interface
{
    ...
    {
        static const std::string s{"com.lomiri.remote.Service.Provider"};
        return s;
    }
    ...
    struct Signals
    {
        DBUS_CPP_SIGNAL_DEF(PositionChanged, remote::Interface, com::lomiri::location::Position)
        DBUS_CPP_SIGNAL_DEF(HeadingChanged, remote::Interface, com::lomiri::location::Heading)
        DBUS_CPP_SIGNAL_DEF(VelocityChanged, remote::Interface, com::lomiri::location::Velocity)
    };
    ...
    struct Skeleton
    {
        ...
        // com::lomiri::remote::Interface on it.
...
#endif // LOCATION_SERVICE_COM_LOMIRI_LOCATION_SERVICE_PROVIDERS_REMOTE_INTERFACE_H_
