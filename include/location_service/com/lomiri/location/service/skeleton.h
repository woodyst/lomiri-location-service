 ...
 */
#ifndef LOCATION_SERVICE_COM_LOMIRI_LOCATION_SERVICE_SKELETON_H_
#define LOCATION_SERVICE_COM_LOMIRI_LOCATION_SERVICE_SKELETON_H_

#include <com/lomiri/location/service/interface.h>
#include <com/lomiri/location/service/permission_manager.h>
...
{
class Skeleton
        : public core::dbus::Skeleton<com::lomiri::location::service::Interface>,
...
public:
    ...
    // From com::lomiri::location::service::Interface
...
private:
    ...
    core::dbus::DBus daemon;
    // The skeleton object representing com.lomiri.location.service.Interface on the bus.
    ...
    // DBus properties as exposed on the bus for com.lomiri.location.service.Interface
    struct
    {
...
#endif // LOCATION_SERVICE_COM_LOMIRI_LOCATION_SERVICE_SKELETON_H_
