 ...
 */
#ifndef LOCATION_SERVICE_COM_LOMIRI_DEFAULT_PROVIDER_SELECTION_POLICY_H_
#define LOCATION_SERVICE_COM_LOMIRI_DEFAULT_PROVIDER_SELECTION_POLICY_H_
...
#endif // LOCATION_SERVICE_COM_LOMIRI_DEFAULT_PROVIDER_SELECTION_POLICY_H_
