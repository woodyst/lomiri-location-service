 ...
 */
#include <com/lomiri/location/providers/geoclue_provider.h>
...
TEST(GeoclueProvider, accessing_ubuntu_geo_ip_works)
{
    ...
    com::lomiri::location::geoclue::Provider::Configuration config
    {
        name,
        path,
        com::lomiri::location::geoclue::Provider::default_feature_flags(),
        com::lomiri::location::geoclue::Provider::default_requirement_flags(),
    };

    com::lomiri::location::geoclue::Provider provider(config);
